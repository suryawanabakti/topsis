...
<div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 max-w-2xl mx-auto">
    <div class="p-6 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-800">Form Edit Kriteria</h3>
    </div>
    <div class="p-6">
        <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="kode" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('kode', $kriteria->kode) }}">
            ...
            <div>
                ...
                <input type="text" name="nama_kriteria" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('nama_kriteria', $kriteria->nama_kriteria) }}">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="bobot" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('bobot', $kriteria->bobot) }}">
